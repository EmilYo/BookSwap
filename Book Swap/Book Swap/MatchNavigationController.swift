...
class MatchNavigationController: BSNavigationController {
    ...
    func configureTabBar() {
        ...
        let tabBarItem = RAMAnimatedTabBarItem(title: L10n.LocTabMatch.string, image: UIImage.Asset.TabMatch.image, selectedImage: nil)
